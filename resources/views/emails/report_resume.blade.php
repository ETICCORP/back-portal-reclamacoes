  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td align="center" style="padding:40px 20px;">
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:640px; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 10px 25px -5px rgba(0,0,0,0.05), 0 8px 10px -6px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="background-color:#0f172a; padding:32px 40px; text-align:left;">
              ...
              <div style="margin-top:8px; display:inline-block; padding:4px 12px; background:rgba(255,255,255,0.1); border-radius:20px; color:#cbd5e1; font-size:12px; font-weight:500; text-transform:uppercase; letter-spacing:0.05em;">
          ...
          <tr>
            <td style="padding:40px 40px 30px 40px;">
              ...
              <p style="margin:0 0 24px 0; font-size:16px; line-height:1.6; color:#475569;">
                Confirmamos a recepção da sua exposição. A nossa equipa de apoio ao cliente já foi notificada e iniciará a análise técnica de imediato.
              </p>

              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:30px; border-collapse:collapse;">
                <tr>
                  <td style="padding:15px; background-color:#f8fafc; border-radius:8px; border:1px solid #f1f5f9;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="padding-bottom:12px; border-bottom:1px solid #e2e8f0;">
                          <span style="font-size:12px; color:#64748b; text-transform:uppercase; font-weight:700;">Detalhes do Processo</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-top:12px;">
                          <p style="margin:4px 0; font-size:14px;"><strong style="color:#1e293b;">Titular:</strong> <span style="color:#64748b;">{{ $complaint->full_name ?? 'N/D' }}</span></p>
                          <p style="margin:4px 0; font-size:14px;"><strong style="color:#1e293b;">Nº Apólice:</strong> <span style="color:#64748b;">{{ $complaint->policy_number ?? 'N/D' }}</span></p>
                          <p style="margin:4px 0; font-size:14px;"><strong style="color:#1e293b;">Entidade:</strong> <span style="color:#64748b;">{{ $complaint->entity ?? 'N/D' }}</span></p>
                          <p style="margin:4px 0; font-size:14px;"><strong style="color:#1e293b;">Data:</strong> <span style="color:#64748b;">{{ optional($complaint->created_at)->format('d/m/Y H:i') ?? now()->format('d/m/Y H:i') }}</span></p>
                        </td>
                      </tr>
                    </table>
                  </td>
