...
@section('content')
    ...
    <div
        ...
        <span
            ...
            Novo Estado do Processo:
        </span>
        <span
            style="display:inline-block; padding:8px 24px; background-color:#3b1e7a; color:#ffffff; font-weight:700; font-size:15px; border-radius:6px; text-transform:uppercase; letter-spacing: 0.02em;">
            {{ $complaint->status instanceof \App\Enum\ClaimStatus ? $complaint->status->value : $complaint->status }}
        </span>
    </div>
