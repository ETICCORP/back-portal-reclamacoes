...
class GrupoAlertEmailsController extends AbstractController
{
    ...
    {
        return [
            'index'  => 'visualizou as áreas responsáveis',
            'show'   => 'visualizou os detalhes da área #:name',
            'store'  => 'registrou uma nova área responsável',
            'update' => 'atualizou os dados da área responsável #:name',
        ];
    }
